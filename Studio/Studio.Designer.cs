namespace TinertiaStudio {
	partial class Studio {
		...
		private void InitializeComponent() {
			...
			this.tasText = new TinertiaStudio.Controls.RichText();
			...
			this.tasText.Language = TinertiaStudio.Controls.Language.TAS;
			...
			this.tasText.TextChanged += new System.EventHandler<TinertiaStudio.Controls.TextChangedEventArgs>(this.tasText_TextChanged);
			...
			this.tasText.LineInserted += new System.EventHandler<TinertiaStudio.Controls.LineInsertedEventArgs>(this.tasText_LineInserted);
			this.tasText.LineNeeded += new System.EventHandler<TinertiaStudio.Controls.LineNeededEventArgs>(this.tasText_LineNeeded);
			this.tasText.LineRemoved += new System.EventHandler<TinertiaStudio.Controls.LineRemovedEventArgs>(this.tasText_LineRemoved);
			// 
			// Studio
			// 
